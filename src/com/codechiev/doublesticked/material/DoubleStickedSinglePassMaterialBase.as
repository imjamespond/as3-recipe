package com.codechiev.doublesticked.material
{
	...
	import com.codechiev.doublesticked.material.pass.DoubleStickedSuperShaderPass;
	 ...
	 */
	public class DoubleStickedSinglePassMaterialBase extends MaterialBase
	{
		protected var _screenPass:DoubleStickedSuperShaderPass;
		private var _alphaBlending:Boolean;
		
		/**
		 * Creates a new SinglePassMaterialBase object.
		 */
		public function DoubleStickedSinglePassMaterialBase()
		{
			super();
			addPass(_screenPass = new DoubleStickedSuperShaderPass(this));
		}
