package com.codechiev.doublesticked.material.pass
{
	...
	//FIXME
	import com.codechiev.doublesticked.material.compilation.DoubleStickedShaderCompiler;
	import com.codechiev.doublesticked.material.method.DoubleStickedBasicDiffuseMethod;
	import com.codechiev.doublesticked.material.method.DoubleStickedShaderMethodSetup;
	 ...
	 */
	public class DoubleStickedCompiledPass extends MaterialPassBase
	{
		...
		//FIXME
		protected var _compiler:DoubleStickedShaderCompiler;	
		public var _methodSetup:DoubleStickedShaderMethodSetup;
		 ...
		 */
		public function DoubleStickedCompiledPass(material:MaterialBase)
		{
			_material = material;
		 ...
		 */
		//FIXME
		protected function createCompiler(profile:String):DoubleStickedShaderCompiler
		{
		 ...
		 */
		public function get diffuseMethod():DoubleStickedBasicDiffuseMethod
		{
			return _methodSetup.diffuseMethod;
		}
		//FIXME
		public function set diffuseMethod(value:DoubleStickedBasicDiffuseMethod):void
		{
		...
		{
			_methodSetup = new DoubleStickedShaderMethodSetup();//FIXME
