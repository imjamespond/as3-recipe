package com.codechiev.doublesticked.material.pass
{
	...
	import com.codechiev.doublesticked.material.compilation.DoubleStickedSuperShaderCompiler;
	 ...
	 */
	public class DoubleStickedSuperShaderPass extends DoubleStickedCompiledPass
	{
		 ...
		 */
		public function DoubleStickedSuperShaderPass(material:MaterialBase)
		{
			super(material);
		 ...
		 * @inheritDoc
		 */
		override protected function createCompiler(profile:String):DoubleStickedShaderCompiler
		{
			return new DoubleStickedSuperShaderCompiler(profile);
		}
