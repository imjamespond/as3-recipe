package com.codechiev.doublesticked.material.compilation
{
	 ...
	 */
	public class DoubleStickedSuperShaderCompiler extends DoubleStickedShaderCompiler
	{
		 ...
		 */
		public function DoubleStickedSuperShaderCompiler(profile:String)
		{
			super(profile);
		}
		...
		override protected function createNormalRegisters():void
		{
			if (_dependencyCounter.normalDependencies > 0) {
				...
				//===1,change to 2
				_registerCache.addVertexTempUsages(_sharedRegisters.animatedNormal, 2);
		...
		override protected function compileLightingCode():void
		{
			...
			//===2
			_methodSetup._diffuseMethod.distanceRegister =_methodSetup._myMethod1.getDistanceRegister( _registerCache);
			...
			//===2
			_fragmentCode += _methodSetup._myMethod1.getFragmentPostLightingCode(_methodSetup._myMethodVO1,_registerCache, _sharedRegisters.shadedTarget,_methodSetup.diffuseMethod.albedo2);
