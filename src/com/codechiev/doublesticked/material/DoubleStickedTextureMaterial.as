package com.codechiev.doublesticked.material
{
	 ...
	 */
	public class DoubleStickedTextureMaterial extends DoubleStickedSinglePassMaterialBase
	{
		/**
		 ...
		 */
		public function DoubleStickedTextureMaterial(texture:Texture2DBase = null, smooth:Boolean = true, repeat:Boolean = false, mipmap:Boolean = true)
		{
			super();
		...
		public function setR(r:Number):void{
			_screenPass._methodSetup._myMethod1.radius = r;
		}
		
		public function setDualTexture(t:Texture2DBase):void{
			_screenPass._methodSetup.diffuseMethod.texture2 = t;
		}
	}
}
