package com.codechiev.doublesticked.material.method
{
	 ...
	 */
	public class DoubleStickedBasicDiffuseMethod extends LightingMethodBase
	{
		...
		public var albedo2:ShaderRegisterElement;
		...
		public var distanceRegister:ShaderRegisterElement;
		
		/**
		 * Creates a new BasicDiffuseMethod object.
		 */
		public function DoubleStickedBasicDiffuseMethod()
		{
			super();
		}
		...
		//FIXME
		public function set texture2(value:Texture2DBase):void
		{
			_texture2 = value;
		}
		/**
		...
		{
			var diff:DoubleStickedBasicDiffuseMethod = DoubleStickedBasicDiffuseMethod(method);
		...
		override arcane function getFragmentPostLightingCode(vo:MethodVO, regCache:ShaderRegisterCache, targetReg:ShaderRegisterElement):String
		{
			...
			//FIXME
			if(this.distanceRegister != null){
					
			var _diffuseInputRegister:ShaderRegisterElement = regCache.getFreeTextureReg();
			//vo.texturesIndex = _diffuseInputRegister.index;
			albedo2 = regCache.getFreeFragmentVectorTemp();
			regCache.addFragmentTempUsages(albedo2, 1);
			code += getTex2DSampleCode(vo, albedo2, _diffuseInputRegister, _texture2);
			...
			if (_useAmbientTexture) {
				...
				if (_useTexture) {
					//FIXME
					code += "mul " + albedo2 + ".xyz, " + albedo2 + ", " + targetReg + "\n" +
						"mov " + albedo2 + ".w, " + albedo2 + ".w\n";
