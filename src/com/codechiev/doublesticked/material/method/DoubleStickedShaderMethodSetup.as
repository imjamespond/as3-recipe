package com.codechiev.doublesticked.material.method
{
	 ...
	 */
	public class DoubleStickedShaderMethodSetup extends EventDispatcher
	{
		...
		arcane var _diffuseMethod:DoubleStickedBasicDiffuseMethod;//FIXME
		...
		//FIXME
		arcane var _myMethod1 :DoubleStickedDiffuseMethod;
		arcane var _myMethodVO1 : MethodVO;		
		
		/**
		 * Creates a new ShaderMethodSetup object.
		 */
		public function DoubleStickedShaderMethodSetup()
		{
			_methods = new Vector.<MethodVOSet>();
			_normalMethod = new BasicNormalMethod();
			_ambientMethod = new BasicAmbientMethod();
			_diffuseMethod = new DoubleStickedBasicDiffuseMethod();//FIXME
			...
			//FIXME
			_myMethod1 = new DoubleStickedDiffuseMethod();
			_myMethodVO1 = _myMethod1.createMethodVO();
		}
