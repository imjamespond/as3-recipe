package com.codechiev.ribbon.material
{
	import away3d.*;
	 ...
	 */
	public class RibbonTextureMaterial extends RibbonPassMaterialBase
	{
		/**
		 ...
		 */
		public function RibbonTextureMaterial(texture:Texture2DBase = null, smooth:Boolean = true, repeat:Boolean = false, mipmap:Boolean = true)
		{
			super();
		...
		public function setCamera(c:Vector3D):void{
			_screenPass._methodSetup._myMethod1.camera = c;
		}
		
		public function addGeom(g:RibbonGeometry):void{
			_screenPass.geom = g;
		}
	}
}
