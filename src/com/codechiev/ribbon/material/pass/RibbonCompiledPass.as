package com.codechiev.ribbon.material.pass
{
	...
	import com.codechiev.ribbon.base.RibbonCompactSubGeometry;
	import com.codechiev.ribbon.material.compilation.*;
	import com.codechiev.ribbon.material.method.RibbonLightPaintMethod;
	import com.codechiev.ribbon.material.method.RibbonShaderMethodSetup;
	 ...
	 */
	public class RibbonCompiledPass extends MaterialPassBase
	{
		...
		//FIXME
		protected var _compiler:RibbonShaderCompiler;
		protected var _pointIndex:int;
		protected var _diffIndex:int;
		public var _methodSetup:RibbonShaderMethodSetup;
		public var geom:RibbonGeometry;
		 ...
		 */
		public function RibbonCompiledPass(material:MaterialBase)
		{
			_material = material;
		 ...
		 */
		//FIXME
		protected function createCompiler(profile:String):RibbonShaderCompiler
		{
		...
		protected function updateShaderProperties():void
		{
			...
			//FIXME
			_pointIndex = _compiler.pointIndex;
			_diffIndex = _compiler.diffIndex;
		...
		{
			_methodSetup = new RibbonShaderMethodSetup();//FIXME
		...
		override arcane function activate(stage3DProxy:Stage3DProxy, camera:Camera3D):void
		{
			...
			//FIXME
			if(_methodSetup._myMethod1) 
				_methodSetup._myMethod1.activate(_methodSetup._myMethodVO1,stage3DProxy);
		...
		arcane override function render(renderable:IRenderable, stage3DProxy:Stage3DProxy, camera:Camera3D, viewProjection:Matrix3D):void
		{
			...
			//FIXME make sure activeBuffer has been created above;
			if(geom!=null){
				////stage3DProxy._context3D.setVertexBufferAt(_pointIndex, geom._target.activeBuffer, geom._target.pointOffset, Context3DVertexBufferFormat.FLOAT_3);
				stage3DProxy._context3D.setVertexBufferAt(_diffIndex, geom._target.activeBuffer, geom._target.diffOffset, Context3DVertexBufferFormat.FLOAT_4);
			}
		...
		arcane override function deactivate(stage3DProxy:Stage3DProxy):void
		{
			...
			//===3
			if(_methodSetup._myMethod1) 
				_methodSetup._myMethod1.deactivate(_methodSetup._myMethodVO1,stage3DProxy);
		}
