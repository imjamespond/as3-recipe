package com.codechiev.ribbon.material.pass
{
	 ...
	 */
	//FIXME
	public class RibbonSuperShaderPass extends RibbonCompiledPass
	{
		 ...
		 */
		public function RibbonSuperShaderPass(material:MaterialBase)
		{
			super(material);
		 ...
		 */
		//FIXME
		override protected function createCompiler(profile:String):RibbonShaderCompiler
		{
			return new RibbonSuperShaderCompiler(profile);
		}
