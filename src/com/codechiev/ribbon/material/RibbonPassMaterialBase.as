package com.codechiev.ribbon.material
{
	...
	import com.codechiev.ribbon.material.pass.*;
	 ...
	 */
	public class RibbonPassMaterialBase extends MaterialBase
	{
		protected var _screenPass:RibbonSuperShaderPass;
		private var _alphaBlending:Boolean;
		
		/**
		 * Creates a new SinglePassMaterialBase object.
		 */
		public function RibbonPassMaterialBase()
		{
			super();
			//FIXME
			addPass(_screenPass = new RibbonSuperShaderPass(this));
		}
