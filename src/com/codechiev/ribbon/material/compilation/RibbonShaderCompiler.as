package com.codechiev.ribbon.material.compilation
{
	...
	import com.codechiev.ribbon.material.method.*;
	 ...
	 */
	public class RibbonShaderCompiler
	{
		...
		protected var _methodSetup:RibbonShaderMethodSetup;
		...
		//FIXME
		protected var _vertexCode1 : String;
		 ...
		 */
		public function RibbonShaderCompiler(profile:String)
		{
		 ...
		 */
		public function get methodSetup():RibbonShaderMethodSetup
		{
			return _methodSetup;
		}

		public function set methodSetup(value:RibbonShaderMethodSetup):void
		{
			_methodSetup = value;
		}
		...
		public function compile():void
		{
			...
			//FIXME1
			_vertexCode1 = "";
			_methodSetup._myMethod1.sharedRegisters = this._sharedRegisters;//updateMethodRegisters
			_vertexCode1 = _methodSetup._myMethod1.getVertexCode2(_methodSetup._myMethodVO1, _registerCache, this);
			
			//FIXME
//			var vt1:ShaderRegisterElement = _registerCache.getFreeVertexVectorTemp();
//			_registerCache.addVertexTempUsages(vt1,1);
//			pointRegister = _registerCache.getFreeVertexAttribute();
//			pointIndex = pointRegister.index;
//			diffRegister = _registerCache.getFreeVertexAttribute();
//			diffIndex = diffRegister.index;
//			_vertexCode += "mov " + vt1 + ", " + pointRegister + "\n";
//			_vertexCode += "mov " + vt1 + ", " + diffRegister + "\n";
//			_registerCache.removeVertexTempUsage(vt1);
		}
		...
		protected function calculateDependencies():void
		{
			...
			//FIXME2
			setupAndCountMethodDependencies(_methodSetup._myMethod1, _methodSetup._myMethodVO1);
		...
		private function updateMethodRegisters():void
		{
			...
			//FIXME3
			_methodSetup._myMethod1.sharedRegisters = _sharedRegisters;
		}
		...
		{
			return _vertexCode1+_vertexCode;
		}
