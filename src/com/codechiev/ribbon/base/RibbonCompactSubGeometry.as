package com.codechiev.ribbon.base
{
	...
	public class RibbonCompactSubGeometry extends SubGeometryBase implements ISubGeometry
	{
		...
		public function RibbonCompactSubGeometry()
		{
		...
		//FIXME
		public function get activeBuffer():VertexBuffer3D
		{
			return _activeBuffer;
		}

		public function set activeDataInvalid(value:Boolean):void
		{
			_activeDataInvalid = value;
		}
		...
		public function updateData(data:Vector.<Number>):void
		{
			...
			_vertexData = data;
			var numVertices:int = _vertexData.length/vertexStride;//FIXME
		...
		{
			_vertexBuffer[contextIndex] = _activeBuffer = context.createVertexBuffer(_numVertices, vertexStride);//FIXME
		...
		{
			var clone:RibbonCompactSubGeometry = new RibbonCompactSubGeometry();
		...
		//FIXME
		public function get pointOffset():int
		{
			return 13;
		}
		public function get diffOffset():int
		{
			return 17;
		}
