package com.codechiev.ribbon.primitives
{
	 ...
	 */
	public class MyPrimitiveBase extends Geometry
	{
		protected var _geomDirty:Boolean = true;
		protected var _uvDirty:Boolean = true;
		
		private var _subGeometry:RibbonCompactSubGeometry;
		
		/**
		 * Creates a new PrimitiveBase object.
		 * @param material The material with which to render the object
		 */
		public function MyPrimitiveBase()
		{
			_subGeometry = new RibbonCompactSubGeometry();
		 ...
		 */
		protected function buildGeometry(target:RibbonCompactSubGeometry):void
		{
		 ...
		 */
		protected function buildUVs(target:RibbonCompactSubGeometry):void
		{
			throw new AbstractMethodError();
		}
